...
public class Product {
    ...
    public String getProductDescription() {
        return String.format("%s %s € %s kg", name, grossPrice, weight);
    }
    ...
    public BigDecimal getProfitabilityPercentage() {
        BigDecimal difference = grossPrice.subtract(netPrice);
        BigDecimal differenceDivision = difference.divide(grossPrice);
        BigDecimal profitability = differenceDivision.multiply(BigDecimal.valueOf(100));
        return profitability.setScale(4, RoundingMode.FLOOR);
